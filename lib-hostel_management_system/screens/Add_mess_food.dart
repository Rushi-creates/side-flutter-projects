...
import 'package:hostel_management_system/models/newMessModel.dart';
...
class AddMessFood extends StatefulWidget {
  const AddMessFood({Key? key}) : super(key: key);

  @override
  _AddMessFoodState createState() => _AddMessFoodState();
}

class _AddMessFoodState extends State<AddMessFood>
  ...
  fetchDoc() async {
    ...
    if (pathData.exists) {
      ...
      FoodModel foodModelObj = FoodModel.fromMap(fetchDoc!);

      foodNameController.text = foodModelObj.name;
      desController.text = foodModelObj.description;
      priceController.text = foodModelObj.price;
  ...
  AppBar screenHeader() {
    return AppBar(
      ...
      title: Text(
        "Add Mess Food Menu", //give here appBar title
    ...
    return SingleChildScrollView(
      child: Center(
        child: Column(
          ...
          children: [
            // chooseFoodImage(),  // add this later if needed
            profileForm(),
            Divider(thickness: 2),
          ],
        ),
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: "Food Name", //hint text here
                  ),
                ),
                SizedBox(
                ...
                TextFormField(
                  ...
                  controller:
                      desController, //declare a controller and then pass here
                  keyboardType: TextInputType.multiline,
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return 'Field required'; //if empty give error msg here
                  ...
                  decoration: InputDecoration(
                    labelText: "About food", //hint text here
                  ),
                ),
                SizedBox(
                  height: dimVar.height * 0.04,
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: "Price in Rs", //hint text here
                  ),
                ),
                SizedBox(
                  height: dimVar.height * 0.04,
...
//                           uploadFile(fb_Storage_pathArg, selectedFileOrImg)
//                               .then(
//                             (value) {
//                               if (fireS_coll_pathArg == null) {
//                                 FirebaseFirestore.instance
//                                     .collection('Mess Food images')
//                                     .doc(currentUser.uid)
//                                     .set({
//                                   "imgURL": urlDownload,
